...
• In-Scope:
  ...
  - Highlighting medication conflicts
• Out-of-Scope:
...
• Staff (Front Desk/Call Center) – Manage bookings, walk-ins, queues, mark arrivals, review conflicts (Accountable)
...
- **Frontend (FE) Functionality:**
  ...
  - Waitlist handling
  - Secure patient dashboard to view appointments, upload documents, complete intake, and receive notifications
  - Insurance pre-check against internal dummy records
...
- FR-005: System MUST allow staff to manage walk-ins, same-day queues, and mark arrivals.
...
| Staff-controlled walk-in bookings, same-day queue management, and arrival marking   | FR-005                    |
...
| Secure patient dashboard to view appointments, upload documents, complete intake, and receive notifications | FR-018   
...
| FR-005: System MUST allow staff to manage walk-ins, same-day queues, and mark arrivals | UC-001, UC-007      |
...
| FR-010: System MUST enforce strict role-based access control and immutable audit logging| UC-002, UC-008     |
...
| FR-018: System MUST provide each patient with a secure dashboard to view appointments, upload documents, complete intake, and receive notifications. [DETERMINISTIC] | UC-012 |
| FR-017: System MUST allow staff to mark an appointment as 'No Show' if the patient does not arrive, and log this action immutably for audit and future risk assessment. [DETERMINISTIC] | UC-011 |
